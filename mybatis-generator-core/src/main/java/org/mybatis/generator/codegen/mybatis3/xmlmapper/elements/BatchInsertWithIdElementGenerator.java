...
public class BatchInsertWithIdElementGenerator extends AbstractXmlElementGenerator {

    public BatchInsertWithIdElementGenerator() {super();}
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
            "id", introspectedTable.getBatchInsertWithIdStatementId()));
